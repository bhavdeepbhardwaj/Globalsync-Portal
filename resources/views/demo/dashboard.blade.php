                ...
                <div class="col-xl-4 col-lg-6">
                    ...
                    <div class="card" id="widgetUserList">
                        <div class="card-header cover overlay">
                            <img class="cover-image h-200"
                                src="{{ asset('assets//examples/images/dashboard-header.jpg ') }}" alt="..." />
                            ...
                            <ul class="list-group list-group-full list-group-dividered mb-0">
                                    ...
                                    <div class="media">
                                        <div class="pr-20">
                                            <a class="avatar avatar-lg" href="javascript:void(0)">
                                                <img class="img-responsive" src="{{ asset('global/portraits/1.jpg ') }}"
                                                    alt="...">
                                            </a>
                                        </div>
                                ...
                                <li class="list-group-item">
                                    <div class="media">
                                        <div class="pr-20">
                                            <a class="avatar avatar-lg" href="javascript:void(0)">
                                                <img class="img-responsive" src="{{ asset('global/portraits/2.jpg ') }}"
                                                    alt="...">
                                            </a>
                                        </div>
                                        <div class="media-body">
                                ...
                                <li class="list-group-item">
                                    <div class="media">
                                        <div class="pr-20">
                                            <a class="avatar avatar-lg" href="javascript:void(0)">
                                                <img class="img-responsive" src="{{ asset('global/portraits/3.jpg ') }}"
                                                    alt="...">
                                            </a>
                                        </div>
                                        <div class="media-body">
                                ...
                                <div class="chat chat-left">
                                    <div class="chat-avatar">
                                        <a class="avatar" data-toggle="tooltip" href="#" data-placement="left"
                                            title="">
                                            <img src="{{ asset('global/portraits/5.jpg ') }}" alt="Edward Fletcher">
                                        </a>
                                    </div>
                                    <div class="chat-body">
                                ...
                                <div class="chat">
                                    <div class="chat-avatar">
                                        <a class="avatar" data-toggle="tooltip" href="#" data-placement="right"
                                            title="">
                                            <img src="{{ asset('global/portraits/4.jpg ') }}" alt="June Lane">
                                        </a>
                                    </div>
                                    <div class="chat-body">
                        ...
                        <div class="card-footer bg-white">
                            <form>
                                <div class="input-group form-material">
                                    ...
                                    <span class="input-group-btn">
                                        <button class="btn btn-pure btn-default icon md-mail-send"
                                            type="button"></button>
                                    </span>
                                </div>
                            </form>
                    ...
                    <div class="card card-shadow">
                        <div class="card-header cover overlay">
                            <div class="cover-background h-200"
                                style="background-image: url('{{ asset('global/photos/placeholder.png ') }}')"></div>
                        </div>
            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        {{ __('You are logged in As Demo...') }} || {{ changeDateFormate(date('Y-m-d'), 'm/d/Y') }}
                    </div>
                </div>
            </div>
        </div>
