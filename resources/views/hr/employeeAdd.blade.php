...
@section('content')
    ...
    <div class="page">
        ...
        <div class="page-content container-fluid">
            <form id="exampleFullForm" autocomplete="off" method="POST" action="{{ route('hr.employee-data-save') }}" enctype="multipart/form-data">
                {{ csrf_field() }}
                        ...
                        <div class="row row-lg">
                            <div class="col-xl-6 form-horizontal">
                                <div class="form-group row">
                                    <label class="col-xl-6 col-md-4 form-control-label">Profile Photo
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-xl-6 col-md-9">
                                        <input type="date" class="form-control" name="emp_doj" placeholder="YYYY/MM/DD"
                                            required="" />
                                    </div>
                                </div>

                                <div class="form-group row">
                                    <label class="col-xl-6 col-md-4 form-control-label">Designation</label>
                                    <div class="col-xl-6 col-md-9">
                                ...
                                <div class="form-group row">
                                    <label class="col-xl-6 col-md-4 form-control-label">Department</label>
                                    <div class="col-xl-6 col-md-9">
                                ...
                                <div class="form-group row">
                                    <label class="col-xl-6 col-md-4 form-control-label">Gender</label>
                                    <div class="col-xl-6 col-md-9">
                            ...
                            <div class="col-xl-6 form-horizontal">
                                <div class="form-group row">
                                    ...
                                    <div class=" col-xl-6 col-md-9">
                                        <input type="text" class="form-control" name="emp_pan" placeholder="PAN Number"
                                            required="">
                                    </div>
                                </div>
                ...
                <div class="panel">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row row-lg">
                            <div class="col-xl-6 form-horizontal">
                                <div class="form-group row">
                                    <label class="col-xl-6 col-md-4 form-control-label">Payment Mode</label>
                                    <div class="col-xl-6 col-md-9">
                                ...
                                <div class="form-group row">
                                    <label class="col-xl-6 col-md-4 form-control-label">Final CTC</label>
                                    <div class="col-xl-6 col-md-9">
                                        <input type="text" class="form-control" name="final_ctc_all"
                                            placeholder="Final CTC">
                                    </div>
                                </div>
                            ...
                            <div class="col-xl-6 form-horizontal">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-xl-6 col-md-9">
                                        <div class="input-group">
                                            <input type="text" class="form-control" name="annual_ctc_in"
                        ...
                        <div class="row row-lg">
                            ...
                            <div class="col-xl-6 form-horizontal">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class=" col-xl-6 col-md-9">
                                        <input type="text" class="form-control" name="total_verbal_warning"
                            ...
                            <div class="col-xl-6 form-horizontal">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class=" col-xl-6 col-md-9">
                                        ...
                                        <p class="text-help">(123) 123-1234</p>
                                    </div>
                                </div>
                        ...
                        <div class="row row-lg">
                            ...
                            <div class="col-xl-6 form-horizontal">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-xl-6 col-md-9">
                                        <textarea class="form-control" name="emp_desp" rows="4" placeholder="Description"
                                            required=""></textarea>
                                    </div>
                                </div>
